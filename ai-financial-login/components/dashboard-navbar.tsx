        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <div className="hidden md:flex flex-col items-start">
                <span className="text-sm font-semibold text-[#1a1a1a] leading-tight">{user?.name || 'User'}</span>
          ...
          >
            ...
            <DropdownMenuItem 
              ...
              className="cursor-pointer text-[#a50034] hover:bg-red-50 focus:bg-red-50 transition-colors font-medium"
            >
